...
function saveLocal(){ cats = normalizeCategories(cats); STORE.set(LS_LINKS, links); STORE.set(LS_CATS, cats); STORE.set(LS_PROTECTED_CATS, [...protectedCats]); syncCategoriesToNative().catch(()=>{}); }
